						...
						<tr>
							...
							<th colspan="8" class="text-right">
								<form action="" method="POST" class="p-0 m-0">
									...
									<button type="submit" class="btn btn-danger btn-sm" value="delete_selected" onClick="return confirm('¿Estás segur@ de que quieres eliminar a los clientes seleccionados de la base de datos?');">Eliminar seleccionados</button>
								</form>
								<a href="register_client.php" class="btn btn-dark btn-sm" value="add_new">Añadir nuevo</a>
							</th>
						</tr>
					</thead>
